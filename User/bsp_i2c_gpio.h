...
#define I2C_WPB_GPIO_PORT    	GPIOB		              /* GPIO端口 */
#define I2C_WPB_GPIO_CLK 	    RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define I2C_WPB_GPIO_PIN			GPIO_Pin_5			 
...
//控制引脚电平
	...
	#define EEPROM_I2C_WPB_1()		GPIO_SetBits(I2C_WPB_GPIO_PORT,I2C_WPB_GPIO_PIN)
	#define EEPROM_I2C_WPB_0()		GPIO_ResetBits(I2C_WPB_GPIO_PORT,I2C_WPB_GPIO_PIN)
